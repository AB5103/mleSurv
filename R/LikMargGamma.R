#' @title LikMargGamma
#'
#' @description This function calculates neg-loglikelihood for a proportional hazards model with gamma frailty.
#'
...
#' @examples
#' \dontrun{
#' LikMargGamma(y,D,nf,ncl,dist)
#' }
#' @export
#'
LikMargGamma=function(y,D,nf,ncl,dist){
